...
function LoginForm() {
  ...
  // Prefill email if coming from registration or reset page
  useEffect(() => {
      ...
      >
        <Card className="border border-border bg-card/60">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className="text-xs text-indigo-500 hover:text-indigo-400 font-semibold hover:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
          ...
          <CardFooter className="flex justify-center border-t border-border/40 pt-4 text-sm text-zinc-500 dark:text-zinc-400">
            <span>New here?</span>
            <Link href="/register" className="ml-1 text-indigo-500 hover:text-indigo-400 font-semibold hover:underline">
              Create an account
            </Link>
          </CardFooter>
        </Card>
